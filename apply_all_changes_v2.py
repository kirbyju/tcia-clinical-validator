...
# 7. Restructure Navigation and Phases
...
phase_1_2_pattern = r'# PHASE 1: COLUMN HEADERS.*?# Footer'
...
# ============================================================================
    ...
    with st.form("cicadas_form"):
        ...
        if st.form_submit_button("Save & Next"):
            ...
            methods = ""
            if c_m_subjects: methods += f"### Subject Inclusion and Exclusion Criteria\n{c_m_subjects}\n\n"
            if c_m_acquisition: methods += f"### Data Acquisition\n{c_m_acquisition}\n\n"
            if c_m_analysis: methods += f"### Data Analysis\n{c_m_analysis}\n\n"
            if methods: desc.append(f"## Methods\n{methods}")
...
# Footer"""
content = re.sub(phase_1_2_pattern, new_phase_1_2, content, flags=re.DOTALL)
